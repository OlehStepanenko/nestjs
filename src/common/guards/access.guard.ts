...
import {JWTUser, UserJwt} from "src/auth/models";
...
export class AccessGuard implements CanActivate {
    ...
    private checkRoles(context: ExecutionContext, user: JWTUser): void {
        const forMethod = this.reflector.get<UserRole[]>(ROLES_METADATA_KEY, context.getHandler());
        ...
        const forController = this.reflector.get<UserRole[]>(ROLES_METADATA_KEY, context.getClass());
