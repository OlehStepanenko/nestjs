    ...
    password: {
        code: {
            min: {
                ...
                format: Number,
                default: 9_999,
                env: 'PASSWORD_RESET_CODE_MIN_VALUE',
            },
            max: {
                doc: 'Password reset code maximum value',
                format: Number,
                default: 999_999,
                env: 'PASSWORD_RESET_CODE_MAX_VALUE',
            },
            expirationDays: {
...
scheme.validate({allowed: "strict"})

export const config = scheme.getProperties()